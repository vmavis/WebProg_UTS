    ...
    <body>
        ...
        <section class="how_section layout_padding">
            ...
            <div class="how_container" >
                <?php $__currentLoopData = $hist2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="boks">
                        <img src="images/<?php echo e($history2["gambar"]); ?>" style="margin:10px;" >
                        <p style="margin-left:0px;margin-top:20px;"><b> <?php echo e($history2["title1"]); ?> <br> <?php echo e($history2["title2"]); ?> </b><br><i><small> <?php echo e($history2["price"]); ?> <br> <?php echo e($history2["date"]); ?> </small></i></p>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\lecafe\resources\views/hist2.blade.php ENDPATH**/ ?>