    ...
    <body>
        ...
        <section class="how_section layout_padding">
            ...
            <div class="how_container" >
                <?php $__currentLoopData = $hist1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="boks">
                        <img src="images/<?php echo e($history1["gambar"]); ?>" style="margin:10px;" >
                        <p style="margin-left:0px;margin-top:20px;"><b> <?php echo e($history1["title1"]); ?> <br> <?php echo e($history1["title2"]); ?> </b><br><i><small> <?php echo e($history1["price"]); ?> <br> <?php echo e($history1["date"]); ?> </small></i></p>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\lecafe\resources\views/hist1.blade.php ENDPATH**/ ?>